...
import ruRU from '@/plugins/primevue/localization/ruRU'

FilterService.register('arrayContainsById', (value, filter): boolean => {
  ...
  return value.some((valueElement: any) =>
    filter.find((filterElement: any) => filterElement.id === valueElement.id)
  )
})

export default defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(PrimeVue, { locale: ruRU, ripple: true })
